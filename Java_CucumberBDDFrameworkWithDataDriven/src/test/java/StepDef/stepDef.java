...
import XLXS.readerFile.Xls_Reader;
...
public class stepDef extends BaseClass{
	...
	Xls_Reader reader = new Xls_Reader("E:\\Andriod studio\\eclips 2019\\works\\Java_CucumberBDDFramework\\src\\test\\java\\userData\\Info\\DatatInfo.xlsx");
  
	String email = reader.getCellData("userLoginInfo", "user name", 2);
	String password = reader.getCellData("userLoginInfo", "password", 2);
